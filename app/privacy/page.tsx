    ...
    <div className="flex flex-col bg-zinc-900 min-h-screen">
      ...
      <main className="flex-1 container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="prose prose-invert max-w-none">
          ...
          <p className="text-zinc-300 mb-6">
            At CBSE AI, we respect your privacy and are committed to protecting your personal data. This privacy policy will inform you about how we look after your personal data when you visit our website and tell you about your privacy rights and how the law protects you.
          </p>
          
          <h3 className="text-2xl font-semibold text-white mt-8 mb-4">2. The Data We Collect</h3>
          <p className="text-zinc-300 mb-6">
          ...
          <h3 className="text-2xl font-semibold text-white mt-8 mb-4">3. How We Use Your Data</h3>
          <p className="text-zinc-300 mb-6">
          ...
          <h3 className="text-2xl font-semibold text-white mt-8 mb-4">4. Data Security</h3>
          <p className="text-zinc-300 mb-6">
            We have put in place appropriate security measures to prevent your personal data from being accidentally lost, used, or accessed in an unauthorized way, altered, or disclosed. In addition, we limit access to your personal data to those employees, agents, contractors, and other third parties who have a business need to know.
          </p>
          
          <h3 className="text-2xl font-semibold text-white mt-8 mb-4">5. Your Legal Rights</h3>
          <p className="text-zinc-300 mb-6">
          ...
          <h3 className="text-2xl font-semibold text-white mt-8 mb-4">6. Contact Us</h3>
          <p className="text-zinc-300 mb-6">
            If you have any questions about this privacy policy or our privacy practices, please contact us at:
          </p>
          <p className="text-zinc-300 mb-6">
            Email: privacy@cbseai.com
          </p>
        </div>
      </main>
